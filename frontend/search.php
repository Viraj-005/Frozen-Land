...
?>
    ...
    <header class="header">
        ...
        <section class="flex">
            ...
            <div class="icons">
                ...
                <div id="search-btn" class="fas fa-search" title="Search"><a href="search.php"></div></a>
    ...
    <div class="shopping-cart">
        ...
        <section>
            ...
            <div class="box">
                <a href="menu.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times"></a>
    ...
    <section class="search-form" id="search">
        <form action="" method="post">
            <input type="text" name="search_box" required placeholder="Search..." class="box"
                oninvalid="this.setCustomValidity('Type the product name you want to search')"
                onchange="try{setCustomValidity('')}catch(e){}">
            <button type="submit" name="search-btn " class="fas fa-search"></button>
        </form>
    </section>

    <section class="menu-cat" id="menu-cat" style="min-height: 100vh; padding-top:0;">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <img src="../upload_images/<?php echo $fetch_products['image']; ?>" alt="">
                ...
                <form action="" method="post">
                    ...
                    <input type="number" min="1" max="100" value="1" class="qty" name="product_quantity"
            ...
            <?php
                    ...
                    echo '<p class="empty">No such product or category!</p>';
