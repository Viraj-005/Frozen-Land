...
?>
    ...
    <div class="shopping-cart">
        ...
        <section>
            ...
            <div class="box">
                <a href="faq.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times"></a>
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <form action="" method="post">
                ...
                <input type="text" name="number" minlength="10" class="box" placeholder="enter your phone number"
