...
?>
    ...
    <section class="menu-cat" id="menu-cat">

        <p class="breadcrumb"><a href="index.php">Home </a>/ <a href="menu.php">Menu </a>/
            <?php echo $_GET['category']; ?></p>
        ...
        <div class="box-container">
            ...
            <?php
                $cat = $_GET['category'];
                $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = '$cat'") or die('query failed');
